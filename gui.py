...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        uic.loadUi("C:\\Bots\\commonData\\importmath\\IM.ui", self)


        self.setWindowFlag(QtCore.Qt.FramelessWindowHint)
        self.setWindowTitle("importmath")
        app_icon = QtGui.QIcon("C:\\Bots\\commonData\\importmath\\imgentray.png")
        self.setWindowIcon(app_icon)



        self.tray_icon = QtWidgets.QSystemTrayIcon(self)
        self.tray_icon.setIcon(QtGui.QIcon("C:\\Bots\\commonData\\importmath\\imgentray.png"))
